...
import Route, { RouteModel } from '../model/workon/route/Route';
import RouteAccess, { RouteAccessModel } from '../model/workon/route/RouteAccess';
import RouteAuth, { RouteAuthModel } from '../model/workon/route/RouteAuth';
...
const RouteAccess = {
  findAll: async function findAll(): Promise<RouteAccess[]> {
    return RouteAccessModel.find({}).lean().exec();
  },
  filters: async function filters(filters: any = {}): Promise<RouteAccess[]> {
...
const RouteAuth = {
  ...
  filters: async function filters(filters: any = {}): Promise<RouteAuth[]> {
    return RouteAuthModel.find(filters).lean().exec()
  },
